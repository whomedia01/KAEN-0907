...
function toDbArticle(art: any) {
  return {
    ...
    image_copyright: art.imageCopyright || art.image_copyright || "한국AI교육일보 DB",
...
function fromDbArticle(row: any): Article {
  return {
    ...
    imageCopyright: row.image_copyright || row.imageCopyright || "한국AI교육일보 DB",
...
export async function saveArticleToSupabase(
  ...
  const fullArticle: Article = {
    ...
    imageCopyright: articleData.imageCopyright || "한국AI교육일보 DB",
