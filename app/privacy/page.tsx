...
const sections = [
  {
    title: '1. 개인정보의 처리 목적',
    body: '한국AI교육신문은 기사제보, 보도자료 접수, 문의 응대, 정정·반론 요청 처리, 서비스 개선, 법령상 의무 이행을 위해 필요한 범위에서 개인정보를 처리합니다.'
  },
  {
  ...
  },
  {
    ...
    body: '한국AI교육신문은 이용자의 동의가 있거나 법령에 근거가 있는 경우를 제외하고 개인정보를 외부에 제공하지 않습니다. 보도 사실 확인을 위해 제보자의 동의가 필요한 경우에는 사전에 별도 확인 절차를 거칩니다.'
  },
  {
    title: '5. 개인정보 처리 위탁',
  ...
  {
    title: '8. 개인정보 보호책임자',
    body: '개인정보 보호책임자는 황광성(대표이사)입니다. 개인정보 관련 문의, 불만 처리, 피해 구제 요청은 공식 이메일(whomedia03@gmail.com) 또는 대표전화(02-6443-4222)를 통해 접수할 수 있습니다.'
  },
  {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <p className="mt-5 text-lg leading-9 text-gray-700">
        한국AI교육신문은 독자의 개인정보를 중요하게 생각하며, 개인정보 보호 관련 법령을 준수하기 위해 다음과 같이 개인정보 처리 기준을 안내합니다.
      </p>
