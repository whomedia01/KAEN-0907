  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4">
      <form action={(formData) => startTransition(async () => setState((await login(formData)) ?? {}))} className="w-full max-w-md rounded-3xl bg-white p-8 shadow-lg">
        <p className="text-xs font-black uppercase tracking-[0.3em] text-slate-500">KOREA AI EDUCATION NEWS CMS</p>
        <h1 className="mt-3 text-2xl font-black text-brand-navy">한국AI교육신문 관리자 로그인</h1>
