...
const sections = [
  ['이용 목적', '한국AI교육신문은 독자가 교육 관련 기사와 정보를 확인할 수 있도록 운영되는 교육 전문 매체입니다. 사이트 이용자는 기사 열람, 검색, 제보, 문의 기능을 이용할 수 있습니다.'],
...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <p className="mt-5 text-lg leading-9 text-gray-700">한국AI교육신문 웹사이트 이용과 기사 열람, 제보, 문의 접수에 관한 기본 안내입니다.</p>
