...
const items = [
  ['정확성', '한국AI교육신문은 확인 가능한 사실과 출처를 바탕으로 기사를 작성하며, 불확실한 정보는 단정적으로 보도하지 않습니다.'],
...
export default function EthicsPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <p className="mt-5 text-lg leading-9 text-gray-700">한국AI교육신문은 교육 전문 인터넷매체로서 독자의 알 권리와 교육 현장의 신뢰를 존중하며 다음의 편집 윤리 기준을 준수합니다.</p>
