...
create table if not exists site_settings (
  ...
  site_name text not null default '에듀저널',
  site_description text not null default '평생교육, 자격증, 시니어 학습, 에듀테크, 교육기관 정보를 다루는 교육 전문 인터넷매체입니다.',
  operator_name text default '(주)후미디어',
  business_name text default '(주)후미디어',
  representative_name text default '황광성',
  business_registration_number text default '119-86-25861',
  mail_order_registration_number text,
  media_registration_status text default 'preparing' check (media_registration_status in ('unregistered','preparing','registered')),
  media_registration_number text,
  media_registered_at date,
  publisher_name text default '황광성',
  editor_name text default '황광성',
  youth_protection_manager text default '황광성',
  privacy_manager text default '황광성',
  address text default '서울특별시 금천구 가산디지털2로 53 (가산동) 한라시그마밸리 1102호 ~ 1104호',
  contact_email text default 'whomedia03@gmail.com',
  contact_phone text default '02-6443-4222',
  contact_fax text default '02-6443-4223',
  logo_url text,
  created_at timestamptz default now(),
